...
INSERT INTO `replyinfo` VALUES (77,69,71,7,'写得不错，赞一个！','写得不错，赞一个！','2022-12-01 09:27:30',NULL);
INSERT INTO `replyinfo` VALUES (78,69,71,7,'写得不错，赞一个！','写得不错，赞一个！','2022-12-01 09:35:50',NULL);
...
CREATE TABLE `topicinfo` (
                             ...
                             `tPublishTime` datetime default Null,
                             `tModifyTime` datetime default NULL,
                             `tisTop` boolean NOT NULL default '0',
                             PRIMARY KEY  (`tId`),
                             KEY `FK_tUId` (`tUId`),
                             KEY `FK_tSId` (`tSId`)
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8;
INSERT INTO `topicinfo` VALUES (55,73,1,'Test','Test',0,0,'2022-11-30 15:59:44',NULL,0);
INSERT INTO `topicinfo` VALUES (56,74,1,'Test','Test',0,0,'2022-11-30 15:59:57',NULL,0);
INSERT INTO `topicinfo` VALUES (57,75,1,'Test','Test',0,0,'2022-11-30 16:00:05',NULL,0);
INSERT INTO `topicinfo` VALUES (59,78,1,'Test','Test',0,0,'2022-11-30 16:00:19',NULL,0);
INSERT INTO `topicinfo` VALUES (60,79,1,'Test','Test',0,0,'2022-11-30 16:00:24',NULL,0);
INSERT INTO `topicinfo` VALUES (61,80,1,'Test','Test',0,0,'2022-11-30 16:00:37',NULL,0);
INSERT INTO `topicinfo` VALUES (62,81,1,'Test','Test',0,0,'2022-11-30 16:00:43',NULL,0);
INSERT INTO `topicinfo` VALUES (68,71,1,'很高兴，能跟大家交流！！','很高兴，能跟大家交流！！',0,0,'2009-11-30 17:01:18',NULL,0);
...
INSERT INTO `userinfo` VALUES (1,'admin','admin',1,'1.gif','2022-11-11 22:17:48',2,1);
INSERT INTO `userinfo` VALUES (7,'test','test',1,'2.gif','2022-11-30 14:52:58',2,1);
INSERT INTO `userinfo` VALUES (8,'javaweb','javaweb',0,'2.gif','2022-01-29 10:34:37',0,1);
INSERT INTO `userinfo` VALUES (13,'qw','qw',0,'3.gif','2022-01-29 11:45:14',0,0);
...
ALTER TABLE `replyinfo`
    ...
    ADD CONSTRAINT `FK_rTId` FOREIGN KEY (`rTId`) REFERENCES `topicinfo` (`tId`) ON DELETE CASCADE ON UPDATE CASCADE;
