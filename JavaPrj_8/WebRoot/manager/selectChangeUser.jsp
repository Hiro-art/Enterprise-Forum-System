...
<script type="text/javascript">
    ...
    function check(){
        ...
        var uId = document.selectChangeUserForm.uId.value;
        var uName = document.selectChangeUserForm.uName.value;
        var uPass = document.selectChangeUserForm.uPass.value;
        var uPass1 = document.selectChangeUserForm.uPass1.value;
...
<body>
    <DIV style="FONT-SIZE: 14px; PADDING-TOP: 60px; FONT-FAMILY: Arial" align=center>
        <DIV align="left">当前操作是：用户信息修改</DIV>
        <HR style="WIDTH: 99%; COLOR: #cccccc; HEIGHT: 1px;">
    </DIV>

    <div class="selectChangeUserForm">
        <form name="selectChangeUserForm" method="post" action="../ServletChangeUser" language="javascript" onsubmit="return check();" id="selectChangeUserForm">
            ...
            <table width="968" align="center" cellpadding="4" cellspacing="0" id="t1">
                <tr>
                    <td width="50%" align="left" valign="top"  class="panelbox">
                        <table width="100%">
                            <tr>
                                <td width="99" style="width: 90px">待修改用户编号：</td>
                                <td width="338">
                            ...
                            <tr>
                                <td width="99" style="width: 90px">新用户名:</td>
                                <td width="338">
                            ...
                            <tr>
                                <td width="99" style="width: 90px">新密码:</td>
                                <td width="338">
                            ...
                            <tr>
                                <td width="99" style="width: 90px">确认新密码:</td>
                                <td width="338">
                            ...
                            <tr>
                                <td width="99" style="width: 90px">请选择新头像:</td>
                                <td>
                            ...
                            <tr>
                                <td width="99" style="width: 90px">用户状态:</td>
                                <td width="338">
                                    锁定<input type="radio" name="state" value="1">
                                    正常<input type="radio" name="state" value="2" checked="checked" />
                                </td>
                ...
                <tr align="center" valign="middle">
                    <td  class="panelbox">
                        <button type="submit" class="btn" id="SubmitAdd" onclick=""><img src="image/submit.gif"/> 修 改 </button>&nbsp;&nbsp;&nbsp;&nbsp;
